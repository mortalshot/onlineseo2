(() => {
    ...
    function initSliders() {
        if (document.querySelector(".template3__slider")) new core(".template3__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".template4__slider")) {
            ...
            function template4MdChange(e) {
                if (e.matches) template4Slider = new core(".template4__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    ...
                    on: {}
                }); else if (template4Slider) template4Slider.destroy();
            }
            template4Md.addEventListener("change", template4MdChange);
            template4MdChange(template4Md);
        }
        if (document.querySelector(".template7__slider")) new core(".template7__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            centeredSlides: true,
        ...
        if (document.querySelector(".template8__slider")) new core(".template8__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".template15__slider")) new core(".template15__slider", {
        ...
        if (document.querySelector(".template17__slider")) new core(".template17__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".template27__slider")) new core(".template27__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
...
***************************************************************************** */
    ...
    function tickerAnimation() {
        ...
        if (tickerItems.length > 0) tickerItems.forEach((element => {
    ...
    function gsapAnimations() {
        ...
        if (template4) {
            ...
            template4Slides.forEach((slide => {
                ...
                if (slideFromLeft.length > 0) slideFromLeft.forEach((element => {
                ...
                if (slideFromRight.length > 0) slideFromRight.forEach((element => {
                    slideTimeline.from(element, {
                        x: 100,
                        duration: .5,
                        ease: "power2.out"
